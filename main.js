...
// let person0 = "Eric"
// document.write("Hello " +person0+ ", would you like to learn some Python today?")
...
// let capitalized = personName.slice(0,1)
// let titlecase = capitalized.toLocaleUpperCase()
// document.write(titlecase+personName.slice(1))
...
// let message = `${famous_person} once said, "${msg}"`;
...
// let nameOfPerson = "\t \n John Doe \t \n";
// document.write("Name with whitespace: " + `"${nameOfPerson}"` + "<br>");

// let strippedName = nameOfPerson.trim();
// document.write("Stripped Name: ");
// document.write(`"${strippedName}"`);
...
// document.write("Subtraction ",12 - 4); 
// document.write("Multiplication ",4 * 2); 
// document.write("Division ",24 / 3); 
...
// document.write(`My favorite number is "${favoriteNumber}"`);
                                            ...
                                            //   and the current date at the top of each program file. Then write one sentence
                                             // describing what the program does.
// just to add comments
// let name01= "Fatima"                                            
// document.write(name01.toLowerCase())   //changing text into lower case                                         
// let name02= "Fatima"                                            
// document.write(name02.toUpperCase())   //changing text into upper case     



                                            //   11. Names: Store the names of a few of your friends in a array called names.
                                            //  Print each person’s name by accessing each element in the list, one at a time.
// let names = ["Seher", "Minahil", "Rabia", "Maryam", "Laraib"];
...
// let namesOfFriends = ["Seher", "Minahil", "Rabia", "Maryam", "Laraib"];
// for (let i = 0; i < namesOfFriends.length; i++) {
//     document.write(`Hey, ${namesOfFriends[i]}! `);}
...
// let transportation = ["car", "motorcycle", "train", "bus" , "plane"];
// for (let i = 0; i < transportation.length; i++) {
//     document.write(`I would like to own a ${transportation[i]}.`+ "<br>");}
...
// let guestList = ["Tayyaba", "Seher", "Natalia"];
// for (let i = 0; i < guestList.length; i++) {
//     document.write(`Dear ${guestList[i]},<br>You are invited to a dinner party that promises to be an evening of delicious food, 
//     lively conversation, and wonderful company. <br>`);}
                                            ...
                                            //   in your list.
// let guestList1 = ["Tayyaba", "Seher", "Natalia"];
// let guestWhoCantMakeIt = guestList1.splice(1, 1, "Laraib"); 
// document.write(`<br>Unfortunately, ${guestWhoCantMakeIt} can't make it to the dinner.<br>`);
// for (let i = 0; i < guestList1.length; i++) {
//     document.write(`Dear ${guestList1[i]},<br>You are invited to a dinner party that promises to be an evening of delicious food
//     , lively conversation, and wonderful company. <br>`);}
...
// let guestList2 = ["Tayyaba", "Laraib", "Natalia"];
// document.write(`<br>Good news! I found a bigger dinner table.<br>`);
// guestList2.unshift("Seher");
// guestList2.splice(2, 0, "Amna");
// guestList2.push("Rabia");
// for (let i = 0; i < guestList2.length; i++) {
//     document.write(`Dear ${guestList2[i]},<br>You are invited to a dinner party that promises to be an evening of delicious food,
//      lively conversation, and wonderful company. <br>`);}
...
// for (let i = guestList2.length - 1; i >= 2; i--) {
//     let removedGuest = guestList2.pop();
//     document.write(`Sorry ${removedGuest}, I can’t invite you to dinner.<br>`);
// }                                         
// for (let i = 0; i < guestList2.length; i++) {
//     document.write(`${guestList2[i]}, you're still invited to dinner.<br>`);
// }
// guestList2.splice(0,2);
// document.write(`Guest list: ${guestList2}<br>`);
...
// let favPlaces = [" Saudia ", " Maldives ", " Thiland ", " France ", " Switzerland "];
// document.write("orignal: "+favPlaces + "<br>");
// document.write("alphabetical order: "+favPlaces.slice().sort() + "<br>");
// document.write("orignal: "+favPlaces + "<br>");
// document.write("reversed alphabetical order: "+favPlaces.slice().sort().reverse() + "<br>");
// document.write("orignal: "+favPlaces + "<br>");
// document.write("Reversed orignal: "+favPlaces.reverse() + "<br>");
// document.write("Reversed again orignal: "+favPlaces.reverse() + "<br>");
// document.write("sorted alphabetical order: "+favPlaces.sort() + "<br>");
// document.write("sorted alphabetical order: "+favPlaces.reverse() + "<br>");


                                              
                                            //   19. Dinner Guests: Working with one of the programs from Exercises 14 through 18, 
                                            // print a message indicating the number of people you are inviting to dinner.
// document.write("Number of people invited to dinner: ", guestList.length);
...
// let example = ["chocolate", "vanilla", "Strawberry", "Butter Pecan", "Mint Chocolate Chip"];
// document.write("Icecream flavors: ", example);
...
// console.log(foodObject);                                            
                                            ...
                                            //  one of your programs yet, try to make one happen. Change an index in one of your programs
                                            // to produce an index error. Make sure you correct the error before closing the program.
// let favPlaces = ["Saudia", "Maldives", "Thailand", "France", "Switzerland"];
// document.write("Original array:", favPlaces);
// document.write("Accessing an index beyond array length to produce an error:");
// document.write(favPlaces[10]); //to produce error
// document.write(favPlaces[2]);
...
//     document.write("You earned 5 points");
// } 
...
//     document.write("You earned 10 points");
// }
...
//     document.write("You earned 15 points");
// }         
...
// let favorite_fruits = ["banana", "mango", "peach"];
// if (favorite_fruits.includes("banana")) {
//     document.write("You really like bananas!<br>");
// }
// if (favorite_fruits.includes("orange")) {
//     document.write("You really like oranges!<br>");
// }
// if (favorite_fruits.includes("mango")) {
//     document.write("You really like mango!<br>");
// }
// if (favorite_fruits.includes("strawberry")) {
//     document.write("You really like strawberries!<br>");
// }
// if (favorite_fruits.includes("pineapple")) {
//     document.write("You really like pineapples!<br>");
// }                                           
...
// let usernames = ["admin", "laiba", "fatima", "anas", "ali"];
...
// let current_users = ["iqra", "alishba", "zoya", "khizra", "kanwal"];
// let new_users = ["maaz", "iqra", "kanwal", "wahaj", "mauviah"];
...
//     }
//     if (usernameExists) {
//         document.write(`The username "${new_users[i]}" already exists. Please enter a new username.`);
//     } else {
//         document.write(`The username "${new_users[i]}" is available.`);
//     }
// }
...
//     if (number === 1) {
//         document.write(`${number}st` + "<br>");
//     } else if (number === 2) {
//         document.write(`${number}nd` + "<br>");
//     } else if (number === 3) {
//         document.write(`${number}rd` + "<br>");
//     } else {
//         document.write(`${number}th` + "<br>");
//     }
// }
                                            ...
                                            //    I really love pizza!
// let pizzas = ["Creamy chicken", "BBQ chicken", "Pepperoni"];
// for (let i = 0; i < pizzas.length; i++) {
//     document.write(`I like ${pizzas[i]} pizza`+ "<br>")
// }
// document.write("I really love pizza!");
                                            ...
                                            //    make a great pet!
// let difAnimals = ["cat", "dog", "parrot"];
// for (let i = 0; i < difAnimals.length; i++) {
//     document.write(`A ${difAnimals[i]} would make a great pet`+ "<br>")
// }
...
//     document.write("The shirt size is " + size + " and it says: " + message) 
// }
...
// make_shirt1();
// make_shirt1("Medium");
// make_shirt1("XL", "this is extra large shirt!");
...
//     return document.write(city + ", " + country);
// }                                               
...
// let magicians_copy = magicians.slice();
// let unchanged_magicians = make_great(magicians_copy);
// show_magicians(magicians);
...
//         }
//     }
//     document.write(" is being ordered.<br>");
// }
// sandwich("cookies", "ice cream");
// sandwich("chicken spread", "cheese", "tomato");
// sandwich("peanut butter", "jelly", "chocolate");    
                                            ...
                                            // stored correctly.
function car(manufacturer, model , ...details) {
    let carDetails = {
        manufacturer: manufacturer,
        model: model
    };
    for (let i = 0; i < details.length; i += 2) {
        carDetails[details[i]] = details[i + 1];
    }
    return carDetails;

}
let car1 = car("Toyota", "Corolla", "color", "blue", "year", 2020);
let car2 = car("Honda", "Civic", "color", "black");

document.write(JSON.stringify(car1) + "<br>");
document.write(JSON.stringify(car2) + "<br>");
